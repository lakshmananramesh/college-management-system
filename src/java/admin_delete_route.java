 ...
 * @author HP
 */
public class admin_delete_route extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet admin_delete_route</title>");            
...
"        </div>");
             ...
             try
           {
               ...
               Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cccms","root","");
                ...
                out.println("<form action=\"admin_delete_route1\">");
                out.println("<center> <h1> DELETE ROUTE </h1>");
