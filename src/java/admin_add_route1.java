 ...
 * @author HP
 */
public class admin_add_route1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet admin_add_route1</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try
            {
               ...
               PreparedStatement p=con.prepareStatement("insert into bus_route values(?,?,?)");
               p.setInt(1,a1);
                p.setString(2,b);
                p.setInt(3,c1);
                p.executeUpdate();
