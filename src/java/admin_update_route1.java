 ...
 * @author HP
 */
public class admin_update_route1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet admin_update_route1</title>");            
...
"        </div>");
           ...
           try
           {
               ...
               Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cccms","root","");
                PreparedStatement p=con.prepareStatement("select* from bus_route where place=?");
                p.setString(1,a);
                ResultSet rs=p.executeQuery();
                out.println(" <div class=\"log_cont\" style=\"float:left; width: 50%;\">");
                
                out.println("<form action=\"admin_update_route2\">");
                out.println("<center> <h1> UPDATE ROUTE </h1>");
                out.println("<table>");
                if(rs.next())
                {
                   out.println("<tr> <th>ROUTE ID: </th> <th><input type=\"text\" name=\"txt1\" class=\"ip_txt\" value="+rs.getInt("id")+"> </th> </tr>");
                    out.println("<tr> <th>ROUTE NAME :</th> <th> <input type=\"text\" name=\"txt2\" class=\"ip_txt\" value="+rs.getString("place")+"> </th> </tr> <br>");
                    out.println("<tr> <th>FEE : </th> <th> <input type=\"text\" name=\"txt3\" class=\"ip_txt\" value="+rs.getInt("fee")+"> </th> </tr> ");
                }
