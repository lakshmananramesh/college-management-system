    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                PreparedStatement ps = con.prepareStatement("Select Stud_id,Password from student where Stud_id = ? and Password = ?");
                ...
                if(rs.next())
                {
                    ...
                    request.getRequestDispatcher("student_home.html").forward(request, response);
                 }
                else
                {
