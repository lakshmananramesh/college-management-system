...
public class student_profile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet student_profile</title>");            
           ...
           try
           {
                ...
                while(rs.next())
                {
                    ...
                    out.println("<tr> <th> NAME : </th> <th>"+rs.getString("name")+ " </th> </tr>");
                    out.println("<tr> <th> PASSWORD : </th> <th>"+rs.getString("password")+ " </th> </tr>");
                }
              
               out.println("</table>");     
               out.println("<br>");     
               
               out.println("<a href=\"student_home.html\"><input type=\"submit\" value=\"OK\" class=\"btn_lg\" align=\"left\"></a>");
               out.println("<br><br>"); 
               out.println("</div>");
               out.println("</center>");
              out.println("</div>"); 
